...
module('Integration | Component | map', function (hooks) {
  ...
  test('it updates the `src` attribute when the arguments change', async function (assert) {
    // We can pass arbitrary values into our component using this.setProperties API.
    // Besides, the value of this here does not refer to the component instance.
    // Instead, this refers to a special test context object, which we have access
    // to insider the render helper.
    this.setProperties({
      lat: 37.7749,
      lng: -122.4194,
      zoom: 10,
