...
module('Integration | Component | rental/detailed', function (hooks) {
  ...
  // Use beforeEach hook to share some boilerplate code, which allow us to have
  // two tests that each focus on a different, single aspect of the component.
  ...
  test('it renders a header with a share button', async function (assert) {
    ...
    assert
      .dom('.jumbo p')
      .containsText('a nice place to say near San Francisco');
